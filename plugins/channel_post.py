...
@Bot.on_message(filters.private & filters.user(ADMINS) & ~filters.command(['start','users','broadcast','batch','genlink','stats', 'fsubs', 'admins', 'fpbroadcast', 'id', 'add_fsub1', 'add_fsub2', 'add_fsub3', 'add_fsub4', 'refresh', 'restart', 'autodel']))
