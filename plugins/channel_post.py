...
@Bot.on_message(filters.private & ~filters.command(['start','users','broadcast','batch','genlink','stats', 'fsubs', 'admins', 'fpbroadcast', 'id', 'add_fsub', 'refresh', 'restart', 'autodel', 'setautodel', 'addadmin', 'rmadmin', 'logs', 'help', 'pbroadcast','request']))
