...
BOT_TOKEN = os.environ.get("BOT_TOKEN", "7295673972:AAHy6HVnSlEOx78vTp01rJcBPLkY7ddSirc")
...
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002360152411"))
...
FORCE_SUB_CHANNEL4 = int(os.environ.get("FORCE_SUB_CHANNEL4", "-1002314875721"))
