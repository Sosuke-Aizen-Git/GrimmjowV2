...
BOT_TOKEN = os.environ.get("BOT_TOKEN", "7173956368:AAGEKUgB4Ch8Dmbvujtjq3Z5gJo9QCTlNpo")
API_ID = int(os.environ.get("API_ID", "22867431"))
...
try:
    ADMINS=[6848088376]
    for x in (os.environ.get("ADMINS", "5743248220 1993048420").split()):
        ADMINS.append(int(x))
except ValueError:
